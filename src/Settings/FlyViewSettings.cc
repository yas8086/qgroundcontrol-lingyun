...
DECLARE_SETTINGSFACT(FlyViewSettings, airshipShowPageFlightCore)
DECLARE_SETTINGSFACT(FlyViewSettings, airshipShowPageBuoyancy)
DECLARE_SETTINGSFACT(FlyViewSettings, airshipShowPageEnergy)
